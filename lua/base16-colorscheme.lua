...
function M.setup(colors, config)
	...
	hi.GitGutterAdd = { guifg = M.colors.base0B, guibg = "NONE", gui = nil, guisp = nil }
	hi.GitGutterChange = { guifg = M.colors.base0D, guibg = "NONE", gui = nil, guisp = nil }
	hi.GitGutterDelete = { guifg = M.colors.base08, guibg = "NONE", gui = nil, guisp = nil }
	hi.GitGutterChangeDelete = { guifg = M.colors.base0E, guibg = "NONE", gui = nil, guisp = nil }
